...
uint8_t cwAutoTextCount = 0;       //cwAutoText Count
uint8_t beforeCWTextIndex = 255;   //when auto cw start, always beforeCWTextIndex = 255, (for first time check)
uint8_t cwAutoDialType = 0;        //0 : CW Text Change, 1 : Frequency Tune
